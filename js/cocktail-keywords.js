const cocktailKeywords = [
    ...
    "Caribbean", "Hot", "Almond", "Shot", "Sweet", "Old", "Virgin",
    ...
    "Mint", "Daiquiri", "Margarita", "Mimosa", "Smash", "Shake", " and ", "Bitter", "Dog", "Cat", "Bunny", " for ", "Rocks",
    "Sling", "Berry", "Champagne", "Jack", "Hawaii", "Cordial", 
    "Fruit", "Spring", "Spice", "Toddy", "Watermelon", "Lassi",
    ".", "/", "-", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", " with ", " of ", " & ", " the ", " a ", " an ", "The ", 
    "Mule", "Horse", "Tiger", "Dragon", "Dry", "Wet"];